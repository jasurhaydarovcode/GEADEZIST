...
const Sidebar: React.FC = () => {
    ...
    return (
        <>
            ...
            >
                {isSidebarOpen ? <IoCloseOutline className="text-3xl" /> : <IoMenu className="text-3xl" />}
            </button>

            {/* Sidebar */}
            <div className={`fixed top-0 left-0 w-80 h-full bg-gray-100 px-4 py-8 transition-transform duration-300 ease-in-out z-50 
