...
const Dashboard = () => {
  ...
  const dataUsers = [
    { id: 1, ism: 'Asilbek', familiya: 'Normuhammadov', kategoriya: 'Топография', viloyat: 'Toshkent', natija: '8/34' },
    { id: 2, ism: 'Shahrixon', familiya: 'Raxmatullayev', kategoriya: 'Маркшейдерлик', viloyat: 'Samarqand', natija: '5/25' },
    { id: 3, ism: 'Otabek', familiya: 'Komilov', kategoriya: 'Умумий Геодезия', viloyat: 'Farg\'ona', natija: '26/40' },
  ];
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-6 flex-1 flex flex-col">
          <div className="grid mb-10 grid-cols-1 md:grid-cols-4 gap-4">
            {cardData.map((item) => (
              <div key={item.id} className="bg-white p-6 shadow-md flex flex-col items-center text-center">
          ...
          {/* Chart Section */}
          <div className="bg-white shadow rounded-lg flex flex-col p-4 mb-6" style={{ height: '800px' }}>
            <div className="flex justify-between items-center mt-8 mb-10 px-6">
              ...
              <button className="bg-gray-100 px-4 py-2 text-gray-600 rounded-sm">Hafta</button>
            </div>
          ...
          <div className="flex justify-between mb-6">
            ...
            <select value={selectedRegion} onChange={handleRegionChange} className="border p-2 rounded">
            ...
            <table className="min-w-full bg-white border">
              <thead>
                <tr>
                  ...
                  <th className="py-2 border">Natija (To'g'ri javoblar/Umumiy)</th>
                </tr>
              </thead>
              <tbody>
                {dataUsers
                  .filter(user => (!selectedCategory || user.kategoriya === selectedCategory) && (!selectedRegion || user.viloyat === selectedRegion))
                  .map(user => (
                    <tr key={user.id}>
