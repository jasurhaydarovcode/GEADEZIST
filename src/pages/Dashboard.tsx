  ...
  const cardData = [
    {
      ...
      count: dashboardStatic.isLoading ? <div role="status">
        <Spinner />
        <span className="sr-only">Loading...</span>
      </div> : staticData?.categoryCount,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white shadow rounded-lg p-4 overflow-x-auto">
          <table className="min-w-full bg-white border">
            ...
            <tbody>
              {getClient.isLoading ? <div role="status" className='flex justify-center items-center'>
                ...
                <span className="sr-only">Loading...</span>
              </div> : (clientData && clientData.length > 0 && clientData.map((user: GetClientAllResponse, index: number) => (
                <tr key={index}>
