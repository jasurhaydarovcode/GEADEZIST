  ...
  return (
    <div className="h-screen px-12 py-12 bg-gray-100 ">
      ...
      <div className="w-[100%] h-[77vh] overflow-y-scroll bg-white p-6 rounded-lg shadow-lg text-gray-500 ">
        <h2 className="text-lg font-semibold ">Foydalanuvchi shartnomasi</h2>
        <p className="text-lg font-semibold">
          GTS – “Geodetic Testing System” test dasturidan foydalanishning qoida
          va shartlari
        </p>
        <p>
        ...
        <p>
          1.1. Shartnoma geodezik nazorat va amaliy bilimlarni baholash tizimi
        ...
        <p>
          ...
          veb-saytidagi har qanday foydalanish huquqini yo'qotishi mumkin.
        </p>
        <p>
        ...
        <p>
          ...
          ishtirokisiz taqdim etiladi.
        </p>
        <p>
          1.7. Ushbu oferta tomonlarining/ishtirokchilarining huquq va
          majburiyatlari veb-sahifada joylashtirilgan va shartnomaning ajralmas
          qismi bo'lgan moddalar va boshqa axborot manbalari bilan tartibga
          solinishi mumkin.
        </p>
        ...
        <p>
          2.1. GTS huquqlari: GTSdan geodezistlarning bilimini baholash uchun
          foydalaning. Sinov natijalari to'g'risida hisobot oling.
        </p>
        <p>
        ...
        <p>
          ...
          ishlashini va foydalanuvchini qo'llab-quvvatlashni ta'minlash. GTSning
          funksionalligini yangilash va yaxshilash.
        </p>
        <p>
          2.4. Pudratchining majburiyatlari: Sinov natijalarini maxfiylik
          siyosatiga muvofiq saqlang.
        </p>
        <h3 className="text-lg font-semibold ">
        ...
        <p>
          ...
          oshirganlaridan so'ng test ishlash imkoniyati taqdim etiladi.
        </p>
        ...
        <p>
          ...
          foydalanish uchun javobgarlikni oladi.
        </p>
        <h3 className="text-lg font-semibold ">5. Maxfiylik siyosati</h3>
        <p>
          5.1. Tomonlar ushbu shartnomani bajarish jarayonida olingan
          ma'lumotlarning maxfiyligini saqlash majburiyatini oladilar.
        </p>
        <h3 className="text-lg font-semibold ">6. Yakuniy qoidalar</h3>
        <p>
          6.1. Ushbu shartnomaga barcha o'zgartirish kiritilganda ogohlantirish
          beriladi va foydalanuvchilarning roziligi bilan amalga oshiriladi.
        </p>
      </div>
    </div>
  );
