...
function Profile() {
  ...
  const getProfileData: GetProfileType | undefined = (getUserProfile.data as UserProfileData)?.body;


  return (
    <Layout>
      {getUserProfile.isLoading ? <div role="status" className="flex justify-center items-center h-screen">
        <svg aria-hidden="true" className="inline w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="w-full max-w-7xl bg-white shadow-md rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={getProfileData?.firstName == null ? 'No first name' : getProfileData?.firstName || ""}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={getProfileData?.regionName == null ? 'No region' : getProfileData?.regionName || "Qashqadaryo Viloyati"}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-3"
                  readOnly
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={getProfileData?.districtName == null ? 'No district' : getProfileData?.districtName || "Qarshi Shaxri"}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-3"
                  readOnly
                />
              </div>
